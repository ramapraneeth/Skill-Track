        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-xl p-6 sm:p-8 shadow-xs text-center space-y-5 transition-colors">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed max-w-sm mx-auto">
              Government Ministry officials, state skill mission directors, and statutory program officers are pre-authorized through institutional credentialing. Public self-registration is not available.
            </p>
          </div>
